...
<div class="container">
    ...
    <p>
        ...
        or all different. For example the following three cards form a set since the colors are all different, the shapes are all the same, the fills are all different, and the numbers are the same.</p>
    <div class="cards">
